...
kotlin {
    androidLibrary {
        namespace = "com.inspiredandroid.red.shared"
        compileSdk =
    ...
    listOf(
        ...
        iosTarget.binaries.framework {
            ...
            binaryOption("bundleId", "com.inspiredandroid.red.composeapp")
        }
    }
...
compose.desktop {
    application {
        mainClass = "com.inspiredandroid.red.MainKt"
...
class VersionGeneratorPlugin : Plugin<Project> {
    override fun apply(project: Project) {
        project.afterEvaluate {
            ...
            val versionFile =
                layout.buildDirectory
                    .file("generated/src/commonMain/kotlin/com/inspiredandroid/red/Version.kt")
                    .get()
                    .asFile
