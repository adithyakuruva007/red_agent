...
class RunFineTuning {
    ...
    fun `run fine-tuning job`() = runBlocking {
        ...
        if (finalJob.fine_tuned_model != null) {
            ...
            println()
            println("  To use this model in Red:")
            ...
            println("  RED_INTEGRATION=1 RED_MISTRAL_FT_KEY=${"$"}MISTRAL_API_KEY RED_MISTRAL_FT_MODEL=${finalJob.fine_tuned_model} \\")
            println("    ./gradlew :composeApp:desktopTest --tests \"*RedUiValidationTest*\" --info")
        } else {
