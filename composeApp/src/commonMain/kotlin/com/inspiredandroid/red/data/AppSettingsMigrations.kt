...
import com.inspiredandroid.red.data.AppSettings.Companion.KEY_APP_OPENS
import com.inspiredandroid.red.data.AppSettings.Companion.KEY_BASE_URL_V1_MIGRATION_COMPLETE
import com.inspiredandroid.red.data.AppSettings.Companion.KEY_CURRENT_SERVICE_ID
import com.inspiredandroid.red.data.AppSettings.Companion.KEY_INSTANCE_MIGRATION_COMPLETE
import com.inspiredandroid.red.data.AppSettings.Companion.KEY_MIGRATION_COMPLETE
import com.inspiredandroid.red.data.AppSettings.Companion.KEY_SERVICES_MIGRATION_COMPLETE
...
fun AppSettings.migrateConfiguredServicesIfNeeded() {
    ...
    val currentServiceId = settings.getString(KEY_CURRENT_SERVICE_ID, "")
    val currentService = if (currentServiceId.isNotEmpty()) Service.fromId(currentServiceId) else null
    if (currentService != null && currentService.id !in existingServiceIds) {
