...
interface DataRepository {
    ...
    val appNotifications: StateFlow<List<AppNotification>>
    fun addAppNotification(title: String, content: String, conversationId: String? = null)
    fun deleteAppNotification(id: String)
    fun clearAllAppNotifications()
    fun markNotificationsAsRead()

    // Per-conversation service routing
    suspend fun setConversationServiceInstanceId(id: String, instanceId: String)
    fun getSelectedServiceInstanceId(): String?
    fun setSelectedServiceInstanceId(instanceId: String?)

    // Custom Context Management
    val contextFiles: StateFlow<List<ContextFile>>
    val referencedConversationIds: StateFlow<Set<String>>
    fun addContextFile(name: String, content: String)
    fun removeContextFile(name: String)
    fun toggleReferencedConversation(id: String)
