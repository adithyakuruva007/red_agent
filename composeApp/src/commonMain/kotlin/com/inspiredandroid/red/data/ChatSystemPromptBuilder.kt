...
enum class SystemPromptVariant {
     ...
     * memory category dumps, scheduled tasks, Structured Learning guidance, and red-ui
...
/** Which red-ui section, if any, to render. */
 ...
 * admitting a tool returned nothing readable, and (2) red-ui buttons whose labels
...
private fun StringBuilder.appendDynamicUiSection() {
    ...
    append("Use them selectively when it fits the user's requirement (e.g. when they ask for a form, option selectors, configuration sliders, structured multi-step tasks, or when explicitly requested). ")
    append("Do not generate red-ui blocks for simple plain text questions unless it benefits the user. ")
    ...
    append(RED_UI_COMPONENT_CATALOG)
    append("Layout tips:\n")
...
/**
 * Pre-computed red-ui component catalog text — shared between [appendDynamicUiSection]
 ...
 */
private val RED_UI_COMPONENT_CATALOG: String = buildString {
