...
import com.inspiredandroid.red.ui.components.RedSearchField
...
import red.composeapp.generated.resources.sandbox_packages_action_clear_search
import red.composeapp.generated.resources.sandbox_packages_action_install
import red.composeapp.generated.resources.sandbox_packages_action_uninstall
import red.composeapp.generated.resources.sandbox_packages_action_upgrade
import red.composeapp.generated.resources.sandbox_packages_empty_installed
import red.composeapp.generated.resources.sandbox_packages_empty_results
import red.composeapp.generated.resources.sandbox_packages_search_hint
import red.composeapp.generated.resources.sandbox_packages_uninstall_confirm
import red.composeapp.generated.resources.sandbox_packages_uninstall_message
import red.composeapp.generated.resources.sandbox_packages_uninstall_title
        ...
        trailingContent = {
            Box(
                ...
                if (mutating) {
                    ...
                    TextButton(shape = androidx.compose.foundation.shape.RoundedCornerShape(8.dp), onClick = { onUninstall(entry) }, modifier = Modifier.handCursor()) {
                        Text(stringResource(Res.string.sandbox_packages_action_uninstall))
                    }
                } else {
                    TextButton(shape = androidx.compose.foundation.shape.RoundedCornerShape(8.dp), onClick = { onInstall(entry) }, modifier = Modifier.handCursor()) {
