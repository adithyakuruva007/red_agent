...
import com.inspiredandroid.red.ui.dynamicui.RedUiNode
...
@Immutable
data class RedUiBlock(val node: RedUiNode, val rawJson: String) : BlockNode

@Immutable
data class RedUiError(val rawJson: String) : BlockNode
