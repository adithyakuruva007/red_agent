...
data class ColumnNode(
    ...
    @Contextual val children: ImmutableList<RedUiNode> = persistentListOf(),
) : RedUiNode
...
data class ListNode(
    override val id: String? = null,
    @Contextual val items: ImmutableList<RedUiNode> = persistentListOf(),
