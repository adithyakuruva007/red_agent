...
data class ChatActions(
    ...
    val deleteAppNotification: (String) -> Unit,
    val clearAllAppNotifications: () -> Unit,
    val markNotificationsAsRead: () -> Unit,
    val updateInputText: (androidx.compose.ui.text.input.TextFieldValue) -> Unit,
)
