...
fun Modifier.animatedGradientBorder(
    ...
    val themeTertiary = MaterialTheme.colorScheme.primaryContainer
    ...
    val colorStops = remember(themePrimary, themeSecondary, themeTertiary) {
        arrayOf(
            0f to Color.Transparent,
            0f to themePrimary,
            0f to themeSecondary,
            0f to themeTertiary,
    ...
    return this.drawWithCache {
        ...
        onDrawWithContent {
            ...
            var colA = themePrimary
            var colB = themeSecondary
            var colC = themeTertiary
            if (posA > posB) {
                val tp = posA
                posA = posB
                posB = tp
