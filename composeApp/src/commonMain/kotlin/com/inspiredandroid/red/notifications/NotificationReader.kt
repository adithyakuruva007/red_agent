 ...
 *
 * Unlike [com.inspiredandroid.red.sms.SmsReader] which queries the system content
 * provider, this reads from the in-process [com.inspiredandroid.red.data.NotificationStore]
