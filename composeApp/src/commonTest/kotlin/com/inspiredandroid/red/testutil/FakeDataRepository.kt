...
package com.inspiredandroid.red.testutil
...
import com.inspiredandroid.red.data.FallbackStatus
import com.inspiredandroid.red.data.HeartbeatConfig
...
import com.inspiredandroid.red.data.ServiceInstance
...
class FakeDataRepository : DataRepository {
    ...
    private var currentService: Service = Service.OpenRouter
    ...
    override suspend fun ask(
        ...
        uiSubmission: com.inspiredandroid.red.data.UiSubmission?,
        activeSkillId: String?,
    ) {
        if (currentConversationId.value == null) {
            currentConversationId.value = currentConversationIdOrNull() ?: kotlin.uuid.Uuid.random().toString()
        }
    ...
    var usingSharedKey = false
    override fun isUsingSharedKey(): Boolean = usingSharedKey
    ...
    override suspend fun toggleStarConversation(id: String) {
        savedConversations.update { list ->
            list.map { if (it.id == id) it.copy(isStarred = !it.isStarred) else it }
        }
    }
    ...
    var skills: List<com.inspiredandroid.red.skills.SkillManifest> = emptyList()

    override fun getInstalledSkills(): List<com.inspiredandroid.red.skills.SkillManifest> = skills
    override suspend fun uninstallSkill(id: String) {}
    override suspend fun browseSkillMarketplaces(): Result<List<com.inspiredandroid.red.skills.RegistrySkillEntry>> = Result.success(emptyList())
    override suspend fun installBrowsedSkill(entry: com.inspiredandroid.red.skills.RegistrySkillEntry): Result<com.inspiredandroid.red.skills.SkillManifest> = Result.failure(NotImplementedError())
    override suspend fun installGitHubSkill(owner: String, repo: String, ref: String, path: String): Result<com.inspiredandroid.red.skills.SkillManifest> = Result.failure(NotImplementedError())
    ...
    override fun getNotificationSyncState(): com.inspiredandroid.red.data.NotificationSyncState = com.inspiredandroid.red.data.NotificationSyncState()
    ...
    override val appNotifications: StateFlow<List<AppNotification>> = MutableStateFlow(emptyList())
    ...
    override fun getSelectedServiceInstanceId(): String? = null
    override fun setSelectedServiceInstanceId(instanceId: String?) {}

    override val contextFiles: StateFlow<List<ContextFile>> = MutableStateFlow(emptyList())
    override val referencedConversationIds: StateFlow<Set<String>> = MutableStateFlow(emptySet())
    ...
    override val obsidianVaultPath: StateFlow<String> = MutableStateFlow("")
    override fun getObsidianVaultPath(): String = ""
    override fun setObsidianVaultPath(path: String) {}
}
