...
import com.inspiredandroid.red.sandbox.SessionShell
import com.inspiredandroid.red.sandbox.openFileWithIntent
import com.inspiredandroid.red.sandbox.resolveSandboxAbsolute
...
class AndroidSandboxController : SandboxController {
    ...
    override fun transcriptFor(sessionId: String): SnapshotStateList<com.inspiredandroid.red.TerminalLine> = sandboxManager.transcriptFor(sessionId)
