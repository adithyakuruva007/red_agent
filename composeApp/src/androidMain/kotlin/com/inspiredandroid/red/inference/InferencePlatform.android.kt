...
actual fun updateDownloadNotificationProgress(percent: Int) {
    try {
        ...
        val builder = android.app.Notification.Builder(context, "red_model_download_channel")
        val notification = builder
            .setContentTitle(context.getString(com.inspiredandroid.red.shared.R.string.app_name))
