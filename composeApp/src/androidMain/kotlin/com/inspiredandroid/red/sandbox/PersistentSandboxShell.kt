...
import com.inspiredandroid.red.smartTruncate
...
private const val PID_PROBE_PREFIX = "${RS}REDBASHPID$US"
...
class PersistentSandboxShell(
    ...
    suspend fun run(
        ...
        val cmdFile = File(tmpPath, ".red_cmd_$nonce")
        try {
        ...
        val line = ". /tmp/.red_cmd_$nonce; __red_st=\$?; rm -f /tmp/.red_cmd_$nonce; " +
            "printf '\\n\\036%s\\037%d\\037%d\\037%s\\036\\n' '$nonce' \"\$__red_st\" \"\$\$\" \"\$PWD\" >&2"
