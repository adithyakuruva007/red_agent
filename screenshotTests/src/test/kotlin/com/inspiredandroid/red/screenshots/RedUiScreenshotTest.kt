...
import com.inspiredandroid.red.ui.LightColorScheme
import com.inspiredandroid.red.ui.Theme
import com.inspiredandroid.red.ui.chat.ChatScreenContent
...
import com.inspiredandroid.red.ui.dynamicui.RedUiParser.UiBlockResult
import com.inspiredandroid.red.ui.dynamicui.RedUiRenderer
import com.inspiredandroid.red.ui.dynamicui.LocalPreviewImages
...
/**
 * Screenshot tests for all red-ui component types and realistic screen scenarios.
 */
@OptIn(ExperimentalResourceApi::class)
class RedUiScreenshotTest {
    ...
    private fun Paparazzi.snapRedUi(
        json: String,
        colorScheme: ColorScheme = DarkColorScheme,
        wrapInCard: Boolean = true,
    ) {
        val ui = RedUiParser.parseUiBlockBody(json) as UiBlockResult.Ui
        snap(colorScheme) {
            RedUiRenderer(
                node = ui.node,
                isInteractive = true,
    ...
    private fun Paparazzi.snapRedUiWithImage(
        json: String,
    ...
    fun accordion() {
        paparazzi.snapRedUi(
            """{"type":"column","children":[
                ...
                {"type":"accordion","title":"What is Red?","expanded":true,"children":[
                    {"type":"text","value":"Red is a personal AI assistant that remembers your preferences and gets things done.","style":"body"}
                ]},
                {"type":"accordion","title":"How does memory work?","children":[
                    {"type":"text","value":"Red stores key facts about you locally and recalls them in future conversations.","style":"body"}
                ]},
    ...
    fun scenario_settingsForm_light() {
        paparazzi.snapRedUi(
            """{"type":"column","children":[
                ...
                {"type":"divider"},
                {"type":"text_input","id":"display_name","label":"Display Name","value":"John"},
            ...
            ChatScreenContent(
                uiState = ChatUiState(
                    ...
                    history = persistentListOf(
                        ...
                        History(id = "2", role = History.Role.ASSISTANT, content = redUiContent),
                    ),
    ...
    fun displayElements() {
        paparazzi.snapRedUi(
            """{"type":"column","children":[
                ...
                {"type":"row","children":[
                    {"type":"avatar","name":"John Doe","size":48},
    ...
    fun scenario_userProfile_dark() {
        paparazzi.snapRedUi(
            """{"type":"column","children":[
                {"type":"row","children":[
                    {"type":"avatar","name":"John Doe","size":56},
                    {"type":"column","children":[
                        {"type":"text","value":"John Doe","style":"title","bold":true},
                        {"type":"row","children":[
    ...
    fun scenario_memories_dark() {
        paparazzi.snapRedUi(
            """{"type":"column","children":[
                ...
                {"type":"text","value":"Red remembers what matters to you. Frequently used memories get promoted into the system prompt.","style":"body","color":"secondary"},
                {"type":"row","children":[
