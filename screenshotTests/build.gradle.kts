...
android {
    namespace = "com.inspiredandroid.red.screenshots"
    compileSdk =
...
// Record golden images for red-ui component tests only (faster than full suite)
tasks.register("recordRedUiScreenshots") {
    dependsOn("recordPaparazziDebug")
    doFirst {
        tasks.named("testDebugUnitTest").configure {
            (this as Test).filter.includeTestsMatching("*.RedUiScreenshotTest")
        }
    }
}
    ...
    doLast {
        ...
        val copies =
            buildList<Pair<String, java.io.File>> {
                ...
                // Hero carousel screenshots from RedUiScreenshotTest → site/img/
                mapOf(
                    "RedUiScreenshotTest_scenario_survivalGame_dark" to "survival-dark.png",
                    "RedUiScreenshotTest_scenario_recipeCard_light" to "recipe-light.png",
                    "RedUiScreenshotTest_scenario_sustainableTech_light" to "ecopulse-light.png",
                    "RedUiScreenshotTest_scenario_memories_dark" to "memories-dark.png",
